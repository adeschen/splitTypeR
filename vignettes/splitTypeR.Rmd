...
heatmap visualization to classify 
transcriptomic samples with a gene signature is often employed. This method 
is relatively simple and offers an instant visual support. However, this method
has a few drawbacks:
...
# Loading the `r Rpackage("splitTypeR")` package
